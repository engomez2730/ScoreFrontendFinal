...
const PermissionTestView: React.FC = () => {
  ...
  const { user, hasPermission, joinGame, currentGamePermissions, leaveGame } =
    useAuth();
      ...
      <Space direction="vertical" size="large" style={{ width: "100%" }}>
        ...
        <Card>
          ...
          <Space>
            ...
            <Button icon={<ReloadOutlined />} onClick={testPermissions}>
              Actualizar Test
            </Button>
            <Button danger onClick={handleLeaveGame}>
              Salir del Juego
            </Button>
          </Space>
        </Card>
        ...
        <Card>
          ...
          <pre style={{ background: "#f5f5f5", padding: 12, borderRadius: 4 }}>
            <div>
              <strong>User Role:</strong> {user.rol}
            </div>
            <div>
            ...
            <div>
              ...
              {currentGamePermissions ? "YES" : "NO"}
            </div>
            {currentGamePermissions && (
              <div>
                <strong>Permissions:</strong>{" "}
                {JSON.stringify(currentGamePermissions, null, 2)}
              </div>
            )}
          </pre>
        </Card>
